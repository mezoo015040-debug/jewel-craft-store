      ...
      <div className="container mx-auto px-4">
        <div className="flex h-20 items-center justify-between">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="relative">
                  ...
                  >
                    ...
                    {/* Laurel wreath - left */}
                    <path
                      d="M25 55 Q20 50 20 45 Q20 40 25 38 Q20 45 25 50 Z"
                      fill="#D4AF37"
                    />
                    {/* Laurel wreath - right */}
                    <path
                      d="M55 55 Q60 50 60 45 Q60 40 55 38 Q60 45 55 50 Z"
                      fill="#D4AF37"
                    />
                  </svg>
                </div>
          ...
          <div className="flex items-center gap-3">
            <Button variant="ghost" className="text-sm font-medium text-gray-700 hover:text-primary px-3">
        ...
        <nav className="flex items-center justify-center border-t border-gray-100 py-3">
          <a
            href="#"
            className="text-sm font-medium text-gray-700 hover:text-primary transition-colors px-4"
          >
            سبائك
          </a>
        </nav>
